...
//    }
        ...
        self.NSArrayInExplore = NSArray
         ...
         //print ("let me see: \(self.Explore_Name)")
            DispatchQueue.main.async {
              ...
              // print("final downcast test: \(self.NSArrayInExplore) ")
    ...
    var rowSeleteted:Int = 0
    
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        self.rowSeleteted = indexPath.row
...
//        let FullPageController = navigationController.topViewController as! FullViewController


        let FullPageController = segue.destination as! FullViewController

        FullPageController.FullPageParameters = self.rowSeleteted
